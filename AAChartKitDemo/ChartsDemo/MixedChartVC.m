...
- (CCChartModel *)configureTheChartModel:(NSString *)chartType {
    if ([chartType isEqualToString:@"arearangeMixedLine"]) {
        ...
        .seriesSet(@[
                     ...
                     .dataSet( @[@320, @332, @301, @334, @390]),
                     
                     CCSeriesElement.new
                     .nameSet(@"夏")
                     .typeSet(CCChartType.bar)
                     .labelSet(labelOption)
                     .dataSet(@[@220, @182, @191, @234, @290]),
                     
                     CCSeriesElement.new
                     .nameSet(@"秋")
                     .typeSet(CCChartType.bar)
                     .labelSet(labelOption)
                     .dataSet(@[@150, @232, @201, @154, @190]),
                     
                     CCSeriesElement.new
                     .nameSet(@"冬")
                     .typeSet(CCChartType.bar)
                     .labelSet(labelOption)
                     .dataSet(@[@98, @77, @101, @99, @40]),
                     ]);
        ...
        .seriesSet(@[
                     ...
                     .typeSet(CCChartType.bar)
                     .barGapSet(@0)
                     .dataSet(@[@-0.07, @-0.09, @0.2, @0.44, @-0.23,@0.08,@-0.17,@0.47,@-0.36,@0.18]),
                     ]);
        ...
        CCChartModel *ccChartModel = CCChartModel.new
        .titleTextSet(@"16年1月-16年11月充值客单分析")
        .titleSubtextSet(@"BY MICVS")
        .xAxisDataSet(@[@"一月", @"二月", @"三月", @"四月", @"五月", @"六月", @"七月", @"八月", @"九月", @"十月", @"十一月", @"十二月"])
        .legendDataSet(@[@"新用户",@"老用户",@"总量"])
        .seriesSet(@[
                     CCSeriesElement.new
                     .nameSet(@"新用户")
                     .typeSet(CCChartType.bar)
      ...
      CCChartModel *ccChartModel = CCChartModel.new
        .titleTextSet(@"Linear Regression")
        .seriesSet(@[
                     CCSeriesElement.new
                     .nameSet(@"邮件营销")
