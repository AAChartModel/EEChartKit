...
- (void)configureTheOptionsJsonStringWithAAOptions:(CCOptions *)options {
...
//
- (void)aa_drawChartWithChartModel:(CCChartModel *)chartModel {
...
//
- (void)aa_drawChartWithOptions:(CCOptions *)options {
    if (!_optionJson) {
...
- (void)aa_refreshChartWithOptions:(CCOptions *)options {
    [self configureTheOptionsJsonStringWithAAOptions:options];
    [self drawChart];
}
